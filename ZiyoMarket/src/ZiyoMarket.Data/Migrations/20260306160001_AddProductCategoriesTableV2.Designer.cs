...
namespace ZiyoMarket.Data.Migrations
{
    ...
    [Migration("20260306160001_AddProductCategoriesTableV2")]
    partial class AddProductCategoriesTableV2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ZiyoMarket.Domain.Entities.Users.UserRole", b =>
                {
                    ...
                    b.Property<DateTime>("AssignedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2026, 3, 6, 16, 0, 0, 359, DateTimeKind.Utc).AddTicks(2444));
