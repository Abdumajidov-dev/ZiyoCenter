...
namespace ZiyoMarket.Data.Migrations
{
    ...
    [Migration("20260113071923_AddUnifiedUserRolePermissionSystem")]
    partial class AddUnifiedUserRolePermissionSystem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ZiyoMarket.Domain.Entities.Users.UserRole", b =>
                {
                    ...
                    b.Property<DateTime>("AssignedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2026, 1, 13, 7, 19, 23, 91, DateTimeKind.Utc).AddTicks(4847));
