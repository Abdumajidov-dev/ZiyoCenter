...
namespace ZiyoMarket.Data.Migrations
{
    ...
    [Migration("20260311171022_AddManualPaymentVerificationSystem")]
    partial class AddManualPaymentVerificationSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZiyoMarket.Domain.Entities.Notifications.DeviceToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ZiyoMarket.Domain.Entities.Notifications.SmsLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ZiyoMarket.Domain.Entities.Orders.PaymentProof", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ZiyoMarket.Domain.Entities.Products.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ZiyoMarket.Domain.Entities.Products.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ZiyoMarket.Domain.Entities.Users.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ZiyoMarket.Domain.Entities.Users.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ZiyoMarket.Domain.Entities.Users.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ZiyoMarket.Domain.Entities.Users.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime>("AssignedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2026, 3, 11, 17, 10, 22, 371, DateTimeKind.Utc).AddTicks(3502));
            ...
            modelBuilder.Entity("ZiyoMarket.Domain.Entities.Notifications.DeviceToken", b =>
                {
                    b.HasOne("ZiyoMarket.Domain.Entities.Users.User", null)
            ...
            modelBuilder.Entity("ZiyoMarket.Domain.Entities.Users.RolePermission", b =>
                {
                    ...
                    b.HasOne("ZiyoMarket.Domain.Entities.Users.Role", "Role")
                        .WithMany("RolePermissions")
            ...
            modelBuilder.Entity("ZiyoMarket.Domain.Entities.Users.UserRole", b =>
                {
                    ...
                    b.HasOne("ZiyoMarket.Domain.Entities.Users.User", "User")
                        .WithMany("UserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
