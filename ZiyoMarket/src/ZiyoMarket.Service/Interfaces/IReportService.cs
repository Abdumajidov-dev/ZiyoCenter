...
public interface IReportService
{
    ...
    Task<Result<DashboardStatsDto>> GetDashboardStatisticsAsync();
    Task<Result<DashboardStatsDto>> GetTodayStatisticsAsync();
    ...
    Task<Result<SalesReportDto>> GetDailySalesAsync(DateTime date);
    ...
    Task<Result<List<TopProductDto>>> GetTopSellingProductsAsync(DateTime startDate, DateTime endDate, int count = 10);
    ...
    Task<Result<List<TopCustomerDto>>> GetTopCustomersReportAsync(int count = 10);
    ...
    Task<Result<List<LowStockProductDto>>> GetLowStockReportAsync();
    ...
    Task<Result<SellerAnalyticsDto>> GetSellerPerformanceReportAsync(DateTime startDate, DateTime endDate);
